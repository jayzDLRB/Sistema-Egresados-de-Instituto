...
{
  public class CustomCorreoTextBox : UserControl
  {
    ...
    public CustomCorreoTextBox()
    {
      ...
      icon = new PictureBox
      {
        Image = Properties.Resources.MessageIconGray, // Imagen del ícono gris
    ...
    // Propiedad Text para exponer el valor del TextBox
    ...
    protected virtual void TextBox_GotFocus(object sender, EventArgs e)
    {
      ...
      icon.Image = Properties.Resources.MessageIconBlue;
    }
    ...
    protected virtual void TextBox_LostFocus(object sender, EventArgs e)
    {
      if (string.IsNullOrWhiteSpace(textBox.Text))
      {
        ...
        icon.Image = Properties.Resources.MessageIconGray;
      }
    }
  }
}
